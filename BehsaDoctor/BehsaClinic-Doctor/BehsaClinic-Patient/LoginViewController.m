...
- (void)viewDidLoad{
    ...
    //loginTozih
    UILabel *tozihLabel =[[UILabel alloc]initWithFrame:CGRectMake(10, logoImageView.frame.origin.y + logoImageView.frame.size.height + 20, screenWidth - 20, 60)];
...
- (void)loginConnection{
    ...
    NSString *url = [NSString stringWithFormat:@"%@doctor/auth", BaseURL];
