...
#pragma mark - header view
    ...
    if (tempImage) {
        self.imageView = [ImageResizer resizeImageWithImage:tempImage withHeight:screenHeight - 66 withPoint:CGPointMake(10, 66)];
    } else {
        activityIndicator = [[UIActivityIndicatorView alloc]initWithActivityIndicatorStyle:UIActivityIndicatorViewStyleGray];
        ...
        [self.imageView setImageWithURLRequest:imageRequest placeholderImage:nil
                                       success:^(NSURLRequest *request, NSHTTPURLResponse *response, UIImage *image)
         {
             ...
             weakSelf.imageView = [ImageResizer resizeImageWithImage:weakSelf.imageView.image withHeight:screenWidth - 66 withPoint:CGPointMake(0, 66)];
