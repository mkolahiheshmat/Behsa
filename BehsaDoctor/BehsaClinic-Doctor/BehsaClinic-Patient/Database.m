...
+ (int)createLandingPageTable:(NSString*)filePath
{
    ...
    if (SQLITE_OK != rc)
        ...
        {
        char * query ="CREATE TABLE IF NOT EXISTS LandingPage (ID INTEGER PRIMARY KEY AUTOINCREMENT, postID text, title text, content text,contentSummary text,contentHTML text, imageUrl text, publish_date text, categoryId text, categoryName text, userAvatarUrl text, userTitle text, userJobTitle text, userPageId text, userEntity text, userEntityId text, likes_count text, recommends_count text, favorites_count text, liked text, favorite text, recommended text, tags text, postType text, audioUrl text, videoUrl text, audioSize integer, videoSize integer, videoSnapshot text, votingOptions text, coverRatio text)";
        char * errMsg;
...
+ (int)createFavoriteTable:(NSString*)filePath
{
    ...
    if (SQLITE_OK != rc)
        ...
        {
        char * query ="CREATE TABLE IF NOT EXISTS Favorite (ID INTEGER PRIMARY KEY AUTOINCREMENT, postID text, title text, content text,contentSummary text,contentHTML text, imageUrl text, publish_date text, categoryId text, categoryName text, userAvatarUrl text, userTitle text, userJobTitle text, userPageId text, userEntity text, userEntityId text, likes_count text, recommends_count text, favorites_count text, liked text, favorite text, recommended text, tags text, postType text, audioUrl text, videoUrl text, audioSize integer, videoSize integer, videoSnapshot, votingOptions text, coverRatio text)";
        char * errMsg;
        rc = sqlite3_exec(db, query,NULL,NULL,&errMsg);
...
+ (int)insertIntoLandingPageWithFilePath:(NSString *)filePath
                        ...
                        recommends_count:(NSString *)recommends_count
                         favorites_count:(NSString *)favorites_count
                           ...
                           votingOptions:(NSArray *)votingOptions
                              coverRatio:(NSString *)coverRatio{
    ...
    if (SQLITE_OK != rc)
        ...
        NSString * query  = [NSString
                             stringWithFormat:@"INSERT INTO LandingPage(postID, title, content, contentSummary, contentHTML, imageUrl, publish_date, categoryId, categoryName, userAvatarUrl, userTitle, userJobTitle, userPageId, userEntity, userEntityId, likes_count, recommends_count, favorites_count, liked, favorite, recommended, tags, postType, audioUrl, videoUrl, audioSize, videoSize, videoSnapshot, votingOptions, coverRatio) VALUES (\"%@\",\"%@\",\"%@\",\"%@\", \"%@\",\"%@\",\"%@\",\"%@\",\"%@\",\"%@\" ,\"%@\",\"%@\",\"%@\",\"%@\", \"%@\",\"%@\" ,\"%@\",\"%@\" ,\"%@\",\"%@\",\"%@\" ,\'%@\',\"%@\",\"%@\",\"%@\",\'%ld\',\'%ld\',\"%@\",\"%@\",\"%@\")", postID, title, content, contentSummary, contentHTML, imageUrl, publish_date, categoryId, categoryName, userAvatarUrl, userTitle, userJobTitle, userPageId, userEntity, userEntityId, likes_count, recommends_count, favorites_count, liked, favorite, recommended, tagsStr, postType, audioUrl, videoUrl, (long)audioSize, (long)videoSize, videoSnapshot, optionsStr, coverRatio];
...
+ (int)insertIntoFavoriteWithFilePath:(NSString *)filePath
    ...
    if (SQLITE_OK != rc)
        ...
        {
        NSString * query  = [NSString
                             stringWithFormat:@"INSERT INTO Favorite(postID, title, content, imageUrl, publish_date, categoryId, categoryName, userAvatarUrl, userTitle, userJobTitle, userPageId, userEntity, userEntityId, likes_count, recommends_count, favorites_count, liked, favorite, recommended, tags, postType, audioUrl, videoUrl, audioSize, videoSize, videoSnapshot, votingOptions, coverRatio) VALUES (\"%@\",\"%@\",\"%@\",\"%@\", \"%@\",\"%@\",\"%@\",\"%@\" ,\"%@\",\"%@\",\"%@\",\"%@\", \"%@\",\"%@\" ,\"%@\",\"%@\" ,\"%@\",\"%@\",\"%@\" ,\'%@\',\"%@\",\"%@\",\"%@\",\'%ld\',\'%ld\',\"%@\",\"%@\",\"%@\")", postID, title, content, imageUrl, publish_date, categoryId, categoryName, userAvatarUrl, userTitle, userJobTitle, userPageId, userEntity, userEntityId, likes_count, recommends_count, favorites_count, liked, favorite, recommended, tagsStr, postType, audioUrl, videoUrl, (long)audioSize, (long)videoSize,videoSnapshot, optionsStr, coverRatio];
