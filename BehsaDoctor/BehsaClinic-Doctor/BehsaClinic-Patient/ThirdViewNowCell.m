...
#import "ThirdViewNowCell.h"

@interface ThirdViewNowCell ()
@property (strong, nonatomic) UILabel *nameLabel;
@property (strong, nonatomic) UILabel *timeLabel;
@property (strong, nonatomic) UILabel *dateLabel;
@property (strong, nonatomic) UILabel *descriptionLabel;
@property (weak, nonatomic) ThirdViewNowEntity *entity;
@property (strong, nonatomic) NSIndexPath *indexPath;
@end

@implementation ThirdViewNowCell
#pragma mark - Init
...
- (void)setEntity:(ThirdViewNowEntity *)entity indexPath:(NSIndexPath *)indexPath {
    _entity = entity;
